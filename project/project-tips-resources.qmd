...
If you’re using {matplotlib} or {seaborn} functions, the [`subplot_mosaic()`](https://matplotlib.org/stable/api/_as_gen/matplotlib.pyplot.subplot_mosaic.html) function makes it straightforward to arrange plots in a grid.
