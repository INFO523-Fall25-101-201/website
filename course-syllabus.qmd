...
Asynchronous online lectures: {{< var class.day >}} {{< var class.time >}}, {{< var class.location >}}. 
Set your own schedule to watch the lecture videos, but make sure to turn in your assignments and projects on time. 
...
It is my intent that students from all diverse backgrounds and perspectives be well-served by this course, that students' learning needs be addressed both in and out of class, and that the diversity that the students bring to this class be viewed as a resource, strength, and benefit. It is my intent to present materials and activities that are respectful of diversity and in alignment with [{{< var university.short_name >}}'s Commitment to Diversity and Inclusion](https://provost.arizona.edu/content/diversity-inclusion). Your suggestions are encouraged and appreciated. Please let me know ways to improve the effectiveness of the course for you personally, or for other students or student groups.
...
-   **Reading quizzes** (5), due every other week (roughly), completed individually. Each quiz is worth 2% of the grade.
    ...
    Reading quizzes will be linked from the [course schedule]({{< var website.url }}). They always cover reading that is due since the previous quiz and up to and including the deadline for the given quiz. 
...
**<span style="color: #FFBF00">AI is Sometimes Permitted</span>**
...
Following the University's [established AI policy](https://docs.google.com/document/d/1ZE3iWssjpt2XkEH9UvBkJY252Iwyd_4o04o20Ktm-q4/edit?tab=t.0), this class encourages you to use/experiment with Generative AI in all assignments and projects.
- The only exception are **quizzes**. They serve as your own checkpoint and for your reflection purposes. Using AI there is a waste of time (and computing power), especially since we are not grading on whether you get to the correct answer. 
- Always keep control of your code and work by reviewing, criticizing, and steering AI responses While AI-generated code may appear legitimate, [my studies](https://dl.acm.org/doi/full/10.1145/3613904.3642377) show that tools like ChatGPT easily hallucinate or miss your intention. While latest tools such as Claude Code or Cursor may allow "automonous" mode, it is still prone to overthinking or misunderstanding. 
- Whenever you use Generative AI tools, clearly state in your assignment or project write-up which Generative AI tool(s) you used, what you used it for, and how you incorporated its output. In addition, **write reflections about your workflow and AI's responses, which will be graded.**
