...
-   **Homework assignments** (5), due every other week (roughly), completed individually. Each homework assignment is worth 7% of the course grade. Lowest homework assignment score is dropped.
...
-   **Projects** (2), mid-semester and end of semester, completed in teams.
    ...
    -   Project 2: Teams will pick a dataset of interest to them and develop a data mining workflow in Python (problem --\> solution). Project 2 is worth 30% of the course grade.
