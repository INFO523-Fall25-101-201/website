...
Live in-person lectures, {{< var class.day >}} {{< var class.time >}}, {{< var class.location >}}. Attendance is mandatory.

## Course Objective

{{< var course.number >}} is a required course in the iSchool's M.S. program. As a multidisciplinary field, the course introduce concepts and work from many areas critical to information studies including statistics, machine learning, pattern recognition, database technology, and data visualization.  
...
An up-to-date schedule, assignments, and due dates can be found on the course website: [{{< var website.url >}}]({{< var website.url >}}).
...
-   **Reading quizzes** (6), due every other week (roughly), completed individually. Each quiz is worth 2% of the grade. Lowest quiz score is dropped.
    ...
    Reading quizzes will be linked from the [course schedule](https://datamineaz.org/). They always cover reading that is due since the previous quiz and up to and including the deadline for the given quiz. They're due by 11:59pm on the indicated day on the [course schedule](https://datamineaz.org/).
...
-   **Homework assignments** (6), due every other week (roughly), completed individually. Each homework assignment is worth 9% of the course grade. Lowest homework assignment score is dropped.
    ...
    Homework assignments are due by 11:59pm on the indicated day on the [course schedule](https://datamineaz.org/).
...
-   **{{< var academic_calendar.classes_begin.date >}}:** {{< var academic_calendar.classes_begin.note >}}
-   **{{< var academic_calendar.mlk_day.date >}}:** {{< var academic_calendar.mlk_day.note >}}
-   **{{< var academic_calendar.drop_add_ends.date >}}**: {{< var academic_calendar.drop_add_ends.note >}}
-   **{{< var academic_calendar.last_drop_without_w.date >}}**: {{< var academic_calendar.last_drop_without_w.note >}}
-   **{{< var academic_calendar.spring_recess.date >}}**: {{< var academic_calendar.spring_recess.note >}}
-   **{{< var academic_calendar.last_withdraw_online.date >}}**: {{< var academic_calendar.last_withdraw_online.note >}}
-   **{{< var academic_calendar.last_day_of_class.date >}}**: {{< var academic_calendar.last_day_of_class.note >}}
-   **{{< var academic_calendar.final_presentations.date >}}**: {{< var academic_calendar.final_presentations.note >}}, {{< var academic_calendar.final_presentations.time >}}

**{{< var academic_calendar.final_presentations.date >}}, {{< var academic_calendar.final_presentations.time >}}**

For more important dates, see the full [{{< var university.short_name >}} Academic Calendar]({{< var resources.academic_calendar_url >}}).
