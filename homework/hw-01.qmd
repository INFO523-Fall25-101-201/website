...
-   Define two variables: an integer named `age` with a value of 25 and a string named `course` with the value "{{< var course.name >}}".
...
{{< var instructions.submission_guidelines >}}
...
{{< var grading.points_distribution >}}
