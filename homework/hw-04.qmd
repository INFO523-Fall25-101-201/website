...
For this Homework, find the types of regressions, their pros and cons, and implementation [here](https://{{< var website.url >}}/tables/model-cheatsheet.html). 
...
**Deliverables:**
- A Jupyter Notebook (with Quarto configuration) containing all code and visualizations.
...
**Grading Rubric:**
Your work will be evaluated based on the completeness and correctness of the code, quality and clarity of visualizations and summary report, proper use of comments and documentation, and adherence to submission guidelines.
