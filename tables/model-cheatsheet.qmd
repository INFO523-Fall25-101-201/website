...
## Model<br>Selection/<br>Validation

```{r, echo=FALSE}
# Create the tibble
# Create the tibble for combined information
combined_model_methods <- tibble(
  `Technique` = c(
    ...
    "[The Validation Set Approach](https://en.wikipedia.org/wiki/Training,_validation,_and_test_sets)",
    ...
    "[The Bootstrap Method](https://en.wikipedia.org/wiki/Bootstrapping_(statistics))"
  ),
  Strengths = c(
