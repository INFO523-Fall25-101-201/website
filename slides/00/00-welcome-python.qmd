...
::: task
-   **Introduction (by Monday 11:59pm):** Post a brief introduction in the #introductions channel on Slack -- include your name (with pronunciation guide if helpful), year, major, location/timezone, and one thing you're excited to learn about data mining
...
-   **Synthesis:** I will summarize key themes from your discussions in our next async update
:::
